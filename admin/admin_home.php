					...
					<div class="cd-radial-slider-content">
						<div class="wrapper">
							<div class="text-center">
								...
								<h3> System </h3>
								<a href="admin_about.php" class="read">Read More <i class="fas fa-caret-right"></i></a>
							</div>
						</div>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="index.php">In <span class="display"> Trend</span></a>
		</div>
